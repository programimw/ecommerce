...
elseif ($_POST['action'] == "create_customer_and_pay") {
    ...
    $product_id = mysqli_real_escape_string($conn, $_POST['uniqueid']);
    ...
    try {
         ...
         */
//         $transaction_details = \Stripe\BalanceTransaction::retrieve($intent->charges->data[0]->balance_transaction);
